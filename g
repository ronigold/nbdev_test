...
Ancillary Commands / Manipulators
   ...
   mergetool            Run merge conflict resolution tools to resolve merge con
flicts
...
Ancillary Commands / Interrogators
 ...
 a file
   count-objects        Count unpacked number of objects and their disk consumpt
ion
...
Interacting with Others
   ...
   imap-send            Send a collection of patches from stdin to an IMAP folde
r
...
Low-level Commands / Manipulators
   ...
   hash-object          Compute object ID and optionally creates a blob from a f
ile
...
Low-level Commands / Interrogators
   cat-file             Provide content or type and size information for reposit
